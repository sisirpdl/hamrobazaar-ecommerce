...
urlpatterns = [
    ...
    path('password-reset-complete/',auth_views.PasswordResetCompleteView.as_view(template_name="app/password_reset_completed.html"),name='password_reset_complete'),
